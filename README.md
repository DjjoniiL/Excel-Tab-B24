...
`Excel Tab B24 MVP Final v.32` - статическое serverless-приложение для Bitrix24 Marketplace. Оно добавляет в карточку CRM-сделки вкладку `Excel Tab B24` с Excel-подобной таблицей, где пользователь может вести локальную рабочую таблицу сделки, подтягивать поля CRM, считать формулы, форматировать ячейки и выгружать заполненную область в Excel.
...
Ключевые параметры: диаметр дуг `22.5` SVG, толщина дуг `1.9`, общий циферблат `cx='19.8' cy='18.7' r='5.2'`, левая дуга `M22.7 7.4A11.25 11.25 0 1 0 13 24.25`, правая дуга `M7.4 22.7A11.25 11.25 0 1 1 22.7 7.4`.
