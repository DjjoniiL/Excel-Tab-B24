...
Левая иконка undo в блоке `Бэкап` утверждена 2026-08-28. Без прямого запроса пользователя не менять её дизайн, направление указателя, посадку указателя на дугу и толщину дуги.
