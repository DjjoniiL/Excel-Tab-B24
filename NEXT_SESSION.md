...
Проект `DjjoniiL/Excel-Tab-B24` доведен до `Excel таблица в сделке и экспорт MVP Final v.41`.
...
- Номер версии: `v.41`, отображается мелким шрифтом в правом нижнем углу приложения.
...
- `npm test`
- `npm run package`
- Проверить, что zip создан с номером v.41.
