...
Проект `DjjoniiL/Excel-Tab-B24` доведен до `Excel таблица в сделке и экспорт MVP Final v.34`.
...
```text
dist app B24 zip/Excel таблица в сделке и экспорт MVP Final v.34.zip
```
...
- Номер версии: `v.34`, отображается мелким шрифтом в правом нижнем углу приложения.
...
- `npm test`
- `npm run package`
- Проверить, что zip создан с номером v.34.
